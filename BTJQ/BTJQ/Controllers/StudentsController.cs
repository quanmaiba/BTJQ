...
namespace BTJQ.Controllers
{
    public class StudentsController : Controller
    {
        ...
        {
            var employeeContext = _context.Students.Include(s => s.ClassRoom);
        ...
        public async Task<IActionResult> Create([Bind("StudentId,FullName,DOB,Sex,ClassRoomId")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StudentId,FullName,DOB,Sex,ClassRoomId")] Student student)
        {
